 ...
 if(($_REQUEST['requestinfo'] == "") || ($_REQUEST['requestdesc'] == "") || ($_REQUEST['requestername'] == "") || ($_REQUEST['requesteradd1'] == "") || ($_REQUEST['requesteradd2'] == "") || ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterzip'] == "") || ($_REQUEST['requesteremail'] == "") || ($_REQUEST['requestermobile'] == "") || ($_REQUEST['requestdate'] == "")){
  ...
  $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Preencha todos os campos </div>';
   ...
   if($conn->query($sql) == TRUE){
    ...
    $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2" role="alert"> Serviço enviado com sucesso Seu ' . $genid .' </div>';
    session_start();
    $_SESSION['myid'] = $genid;
    ...
    $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2" role="alert"> Não foi possível enviar sua solicitação </div>';
   }
 }
}
?>
<div class="col-sm-9 col-md-10 mt-5">
  <form class="mx-5" action="" method="POST">
    <div class="form-group">
      <label for="inputRequestInfo">Serviço</label>
      <input type="text" class="form-control" id="inputRequestInfo" placeholder="Solicitar Serviço" name="requestinfo">
    </div>
    <div class="form-group">
      <label for="inputRequestDescription">Descrição</label>
      <input type="text" class="form-control" id="inputRequestDescription" placeholder="Descrição do Serviço" name="requestdesc">
    </div>
    <div class="form-group">
      <label for="inputName">Nome</label>
      <input type="text" class="form-control" id="inputName" placeholder="Inserir Nome" name="requestername">
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="inputAddress">Endereço 1 - Rua</label>
        <input type="text" class="form-control" id="inputAddress" placeholder="Nome da Rua" name="requesteradd1">
      </div>
      <div class="form-group col-md-6">
        <label for="inputAddress2">CPF</label>
        <input type="text" class="form-control" id="inputAddress2" placeholder="CPF" name="requesteradd2">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        <label for="inputMobile">Telefone</label>
    ...
    <button type="submit" class="btn btn-danger" name="submitrequest">Enviar</button>
