...
if(!isset($_SESSION['is_login'])){
  if(isset($_REQUEST['rEmail'])){
    ...
    if($result->num_rows == 1){
      ...
      $msg = '<div class="alert alert-warning mt-2" role="alert"> Entrar com E-mail ou Senha Válidos</div>';
    }
  }
} else {
  echo "<script> location.href='RequesterProfile.php'; </script>";
...
<body>
  ...
  <p class="text-center" style="font-size: 20px;"> <i class=" text-primary"></i> <span>Fazer login como Anunciante</span>
  </p>
