...
<div class="col-sm-6 mt-5  mx-3">
  <form action="" class="mt-3 form-inline d-print-none">
    <div class="form-group mr-3">
      <label for="checkid">Entre com ID do Serviço: </label>
  ...
  <h3 class="text-center mt-5">Detalhes do Serviço</h3>
  <table class="table table-bordered">
    <tbody>
      ...
      <tr>
        <td>Informação do Serviço</td>
        <td>
          <?php if(isset($row['request_info'])) {echo $row['request_info']; } ?>
        </td>
      </tr>
      <tr>
        <td>Descrição do Serivço</td>
        <td>
  ...
  <?php } else {
      ...
      Sua solicitação ainda está pendente </div>';
    }
 }
 ?>
