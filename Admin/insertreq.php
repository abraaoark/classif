 ...
 if(($_REQUEST['r_name'] == "") || ($_REQUEST['r_email'] == "") || ($_REQUEST['r_password'] == "")){
  ...
  $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Preencha todos os campos </div>';
   ...
   if($conn->query($sql) == TRUE){
    ...
    $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2" role="alert"> Adicionado com sucesso </div>';
   } else {
    // below msg display on form submit failed
    $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2" role="alert"> Não foi possível adicionar </div>';
   }
 }
 }
?>
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Adicionar novo solicitante</h3>
  <form action="" method="POST">
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-danger" id="reqsubmit" name="reqsubmit">Enviar</button>
