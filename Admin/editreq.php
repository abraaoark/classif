...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Atualizar detalhes do solicitante</h3>
  <?php
 ...
 ?>
  <form action="" method="POST">
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-danger" id="requpdate" name="requpdate">Atualizar</button>
      <a href="requester.php" class="btn btn-secondary">Fechar</a>
    </div>
