...
<div class="col-sm-9 col-md-10">
  <div class="row mx-5 text-center">
    <div class="col-sm-4 mt-5">
      <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Solicitações recebidas</div>
        <div class="card-body">
          <h4 class="card-title">
    ...
    <div class="col-sm-4 mt-5" style="margin-left:32%";>
      <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
        <div class="card-header">Trabalho Atribuído</div>
        <div class="card-body">
          <h4 class="card-title">
            <?php echo $assignwork; ?>
          </h4>
    ...
    <div class="col-sm-4 mt-5" style="display: none;">
      <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
  ...
  <div class="mx-5 mt-5 text-center">
    <!--Table-->
    <p class=" bg-dark text-white p-2">Lista de Solicitantes</p>
    <?php
