 ...
 if(isset($_REQUEST['empupdate'])){
  ...
  $sql = "UPDATE technician_tb SET empName = '$eName', empCity = '$eCity', empMobile = '$eMobile', empEmail = '$eEmail' WHERE empid = '$eId'";
    if($conn->query($sql) == TRUE){
     ...
     $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2" role="alert"> Atualizado com sucesso </div>';
    } else {
     // below msg display on form submit failed
     $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2" role="alert"> Não foi possível atualizar </div>';
    }
  }
  }
 ?>
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Atualizar detalhes do técnico</h3>
  <?php
 ...
 ?>
  <form action="" method="POST">
    ...
    <div class="form-group">
      <label for="empMobile">Telefone</label>
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-danger" id="empupdate" name="empupdate">Atualizar</button>
      <a href="technician.php" class="btn btn-secondary">Fechar</a>
    </div>
